...
namespace Main
{
    public class Character // add many refresh commands for stats, and update commands
    {
        ...
        public Character(Character CurrentPlayer) { }
        ...
        {
            bool Decision = Main.Creation.CharacterWelcome();
            if (Decision == false)
            {
                Console.WriteLine("");
                return;
            }
            CharacterID = Main.Creation.CharacterName();
            Console.WriteLine("\r\nYour name is " + CharacterID + ".\r\n");
            CharacterPass = Main.Creation.CharacterPass();
